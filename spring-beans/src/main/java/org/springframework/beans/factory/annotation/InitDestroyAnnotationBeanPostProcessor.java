...
public class InitDestroyAnnotationBeanPostProcessor
	...
	/**
	 * 构建生命周期元数据（解析带@PostConstruct和@PreDestroy注解的方法），当其构造完成后会将元数据缓存到lifecycleMetadataCache集合中并返回
	...
	private LifecycleMetadata buildLifecycleMetadata(final Class<?> clazz) {
		...
		// 如果当前类存在且父类不为Object基类则循环对父类进行处理
	...
	private class LifecycleMetadata {
		...
		/**
		 * 将初始化和销毁的回调方法注册beanDefinition中,并且标记已经检查过的方法,放入checkedInitMethods,checkDestroyMethods方法集合
