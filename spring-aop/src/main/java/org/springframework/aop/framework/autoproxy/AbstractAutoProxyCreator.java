...
public abstract class AbstractAutoProxyCreator extends ProxyProcessorSupport
	...
	/**
	 * 判断bean的类型是不是内部的类型，比如Advice，Pointcut,Advisor，AOopInfrastructureBean这些是跟AOP相关的，所以不应该被处理
	...
	/**
	 * 进行代理工厂的创建，然后判断是否需要设置proxyTargetClass，以便于后面决定是不是要进行jdk动态代理还是cglib动态代理，然后把通知器advisors包装下，加入到代理工厂，获取代理对象
	...
	protected Object createProxy(Class<?> beanClass, @Nullable String beanName,
		...
		proxyFactory.setTargetSource(targetSource); // 设置到要代理的类
